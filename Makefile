...
OFILES = main.o mylib.o font.o player.o pproj.o invader1.o splashscreen.o winscreen.o losescreen.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h player.h pproj.h invader1.h splashscreen.h winscreen.h losescreen.h
